...
public class TwoBallADefenseIntakeBlue extends SequentialCommandGroup {
    ...
    public TwoBallADefenseIntakeBlue(Shooter shooter, Feeder feeder, Intake intake, Actuators actuators, SwerveDrivetrain drivetrain) {
        ...
        m_intakeA = PathPlanner.loadPath("2BallA-Defense-Intake-1-Blue", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_shootA = PathPlanner.loadPath("2BallA-Defense-Intake-2-Blue", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_intakeOpposite = PathPlanner.loadPath("2BallA-Defense-Intake-3-Blue", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_driveToHangar = PathPlanner.loadPath("2BallA-Defense-Intake-4-Blue", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
