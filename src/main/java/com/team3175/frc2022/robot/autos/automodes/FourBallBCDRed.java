...
public class FourBallBCDRed extends SequentialCommandGroup {
    ...
    public FourBallBCDRed(Shooter shooter, Feeder feeder, Intake intake, Actuators actuators, SwerveDrivetrain drivetrain) {
        ...
        m_intakeC = PathPlanner.loadPath("4BallBCD-1-Red", Constants.FOUR_BALL_MAX_SPEED, Constants.FOUR_BALL_MAX_ACCELERATION);
        m_shootC = PathPlanner.loadPath("4BallBCD-2-Red", Constants.FOUR_BALL_MAX_SPEED, Constants.FOUR_BALL_MAX_ACCELERATION);
        m_intakeBD = PathPlanner.loadPath("4BallBCD-3-Red", Constants.FOUR_BALL_MAX_SPEED, Constants.FOUR_BALL_MAX_ACCELERATION);
        m_shootBD = PathPlanner.loadPath("4BallBCD-4-Red", Constants.FOUR_BALL_MAX_SPEED, Constants.FOUR_BALL_MAX_ACCELERATION);
