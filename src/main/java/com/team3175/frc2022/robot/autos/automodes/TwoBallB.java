...
public class TwoBallB extends SequentialCommandGroup {
    ...
    public TwoBallB(Shooter shooter, Feeder feeder, Intake intake, Actuators actuators, SwerveDrivetrain drivetrain) {
        ...
        m_trajectory = PathPlanner.loadPath("2BallB-1", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_trajectory2 = PathPlanner.loadPath("2BallB-2", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
