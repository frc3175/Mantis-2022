...
public class TwoBallARed extends SequentialCommandGroup {
    ...
    public TwoBallARed(Shooter shooter, Feeder feeder, Intake intake, Actuators actuators, SwerveDrivetrain drivetrain) {
