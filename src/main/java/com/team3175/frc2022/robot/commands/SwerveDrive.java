...
public class SwerveDrive extends CommandBase {
    ...
    public SwerveDrive(SwerveDrivetrain swerveDrivetrain, XboxController driverController, XboxController operatorController, int driveAxis, int strafeAxis, int rotationAxis, int slowMaxAxis, boolean fieldRelative, boolean openLoop) {
    ...
    public void execute() {
        ...
        double maxSlow = m_operatorController.getRawAxis(m_slowMaxAxis);
        ...
        m_translation = new Translation2d(yAxisFiltered, xAxisFiltered).times(Constants.MAX_SPEED * multiplier); //TODO: return this to normal by removing 0.4
